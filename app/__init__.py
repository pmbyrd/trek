...
def create_app(config_class=Config):
    ...
    @app.cli.command('seed-trek-db')
    def seed_all_trek():
        """Mass seed the database."""
        #REVIEW - Try to iterate through all the seed functions
        with app.app_context():
            if app.config['ENV'] == 'development':
               from app.seed.seed import seed_animals, seed_astronomical_object, seed_location, seed_character, seed_movie, seed_conflict, seed_occupation, seed_organization, seed_element, seed_technology, seed_company, seed_performer, seed_species, seed_series, seed_season, seed_episode, seed_spacecraft, seed_spacecraft_class, seed_staff, seed_material, seed_title, seed_food, seed_weapon
